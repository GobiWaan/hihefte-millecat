...
class Joueur:
    ...
    def traitement_angle(self, entree):
        ...
        Pour toute autre entrée, lève une exception de type ValueError
        Exemple:
        se -> SE
        O -> O
        sud-est -> ValueError
    ...
    def traitement_puissance(self, entree):
        ...
        Lève une exception de type ValueError si:
    ...
    def choix_avec_validation(self, question, traitement_entree):
        ...
        pour la retourner.
        La question est posée à nouveau tant que la fonction de traitement lève une ValueError.
